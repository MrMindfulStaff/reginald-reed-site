...
const entities = [
  ...
  },
  {
    ...
    type: "Technology",
    tagline: "REIGN AI — Intelligence infrastructure for workforce ecosystems",
    description:
      "The nervous system. REIGN integrates staffing management, training tracking, compliance monitoring, and decision support into a single AI-powered platform. Turns operational data into strategic intelligence across every entity.",
    feeds: ["All ecosystem entities (operational intelligence)"],
    receives: ["All entities (operational data)"],
    metric: "AI-powered decision architecture",
  },
  {
    num: "04",
