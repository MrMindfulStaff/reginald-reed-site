    ...
    <>
      ...
      <section className="min-h-screen flex flex-col justify-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 pt-32 pb-16 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          {/* Left — Text */}
          <div className="holo-glass holo-corners relative p-8 md:p-10 backdrop-blur-md backdrop-saturate-150">
            <motion.p
            ...
            <motion.h1
              className="holo-text text-5xl md:text-6xl lg:text-7xl font-heading leading-tight mb-8"
            ...
            >
              ...
              <br />
              <span>Liberation Architect.</span>
            </motion.h1>
